...
const Hero = () => {
  return (
     ...
     data-aos-easing="ease-in-sine" className="max-w-xl ml-[5%] z-10 mt-[90%] md:mt-[60%] lg:mt-0">
        ...
        <div className="relative w-[95%] sm:w-48 h-10 bg-gradient-to-r from-[#656565] to-[#e99b63] shadow-[0_0_15px_rgba(255,255,255,0.4)] rounded-full">
          <div className="absolute inset-[3px] bg-black rounded-full flex items-center justify-center gap-2">
            <i className="bx bx-diamond mr-1"></i>
        ...
        <p className="text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]">
          Our platform empowers developers to send reliable, human-focused
          emails that avoid spam filters. Enjoy seamless integration, advanced
          analytics, and robust deliverability for all your communication needs.
        </p>
    ...
    <Spline data-aos="zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="3000"  className="absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm:left-[-2%] h-full" scene="https://prod.spline.design/oS5e53KyqaVDbQB0/scene.splinecode" />
